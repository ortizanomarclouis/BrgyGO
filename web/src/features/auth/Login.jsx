...
function Login({ onNavigate, googleError }) {
  ...
  // The Google OAuth button points to the BACKEND (Railway), not the frontend.
  // Spring Security handles /oauth2/authorization/google and redirects to Google.
  // After Google authenticates, Spring calls our /api/auth/google/callback which
  // creates a one-time token and redirects the browser to the frontend with ?googleToken=XXX
      ...
      <div className="login-content">
        ...
        <div className="login-right">
          <div className="login-card">
            ...
            {/* ✅ FIX: href points to BACKEND /oauth2/authorization/google
                This avoids the cross-domain session problem because Spring
                is the one doing the OAuth dance — the browser just follows redirects. */}
            <a
